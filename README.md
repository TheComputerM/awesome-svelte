...
- [My SvelteKit Starter](https://github.com/moisesvalero/my-sveltekit-starter) - Production-minded SvelteKit starter with Svelte 5 runes, TypeScript, Tailwind CSS v4, i18n, and built-in GEO/AEO discovery endpoints.
