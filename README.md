...
- [svelte-css-short-name-preprocess](https://github.com/Naararouter/svelte-css-short-name-preprocess) - Preprocessor for css class names minification in production.
