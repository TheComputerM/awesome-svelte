...
- [my-sveltekit-starter](https://github.com/moisesvalero/my-sveltekit-starter) - Svelte 5 + SvelteKit 2 Template: 23 components, dark mode, i18n, SEO, and A+ security. Built for vibe coders.
